...
def get_icon():
    winicon = PhotoImage(file="Rose Gold Music Player.png")
...
play_list = Listbox(root, font="Sansarif 12 bold", bd=5,
                    bg="gray", width=37, height=19, selectbackground="black")
scroll.place(x=850, y=80, height=380, width=15)
play_list.place(x=505, y=77, height=100)
scroll.config(command=play_list.yview)
play_list.config(yscrollcommand=scroll.set)

img = PhotoImage(file="Rose Gold Music Player.png", width=500, height=460)
lab = Label(root)
lab.grid()
lab["compound"] = LEFT
lab["image"] = img
...
var = StringVar()
var.set("..............................................................................")
song_title = Label(root, font="Helvetica 12 bold", bg="pink",
...
def about():
    MsgBox = askquestion(
        'About Application', 'Are you sure you want to know about this application', icon='warning')
    if MsgBox == 'yes':
        showinfo( 'This is a music player')
...
button_play = Button(root, text=PLAY, width=6, bd=6, bg="pink",
...
button_stop = Button(root, text=STOP, width=5, bd=5,
                     font="Helvetica, 15", bg="pink", fg="white", command=stop)
button_stop.place(x=225, y=407)

button_prev = Button(root, text=FWD, width=5, bd=5,
                     font="Helvetica, 15", bg="pink", fg="white", command=nextsong)
button_prev.place(x=300, y=407)
button_next = Button(root, text=RWD, width=5, bd=5, bg="pink",
                     fg="white", font="Helvetica, 15", command=prev_song)
button_next.place(x=10, y=407)
button_pause = Button(root, text=PAUSE, width=4, bd=5,
                      font="Helvetica, 15", bg="pink", fg="white", command=pause_unpause)
button_pause.place(x=85, y=407)
button_mute = Button(root, text=unmute, width=2, bd=5,
                     font="Helvetica, 15", bg="pink", fg="white", command=muted)
button_mute.place(x=375, y=407)

button_recording = Button(root, text=recording, width=5, bd=5,
                     font="Helvetica, 15", bg="pink", fg="white", command=recording)
button_recording.place(x=225, y=407)
...
button_load_music = Button(root, text="♫ Click Here To Load The Music ♫", width=43,
                           bd=5, font="Helvetica, 10", bg="pink", fg="white", command=add_songs_playlist)
...
label_time = Label(root, text="00:00:00 / 00:00:00",
                       width=17, font="Helvetica, 10", bg="pink", fg="white")
