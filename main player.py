...
class Player:
    def __init__(self, master):
        ...
        self.threads = []
           ...
           def get_icon():
            self.winicon = PhotoImage(file="Rose Gold Music Player.png")
        ...
        self.play_list = Listbox(master, font="Sansarif 12 bold", bd=5,
                            bg="white", width=37, height=19, selectbackground="pink")
        ...
        files = 'Rose Gold Music Player.png'
...
def about():
    ...
    def help():
        ...
        self.button_recording = Button(master, text=recording, width=5, bd=5,
                            font="Helvetica, 15", bg="black", fg="white", command=recording)
        self.button_recording.place(x=300, y=415)





self.buttonPlayall = Button(self.record = Button(master, text=FWD, width=5, bd=5,
                          font="Helvetica, 15", bg="black", fg="white", command=next)
        self.record.place(x=300, y=415)
